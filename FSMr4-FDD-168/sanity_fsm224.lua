...
--------------------------------------------
    ...
    for uec_id = 1, #PIP_ADDR do
    	for cell_id = 1, total_cell_count do
            ...
            exec('set_ue_group simulated id='..cell_id .. uec_id ..' uec='.. uec_id.. ' category=5  eia=null eea=null cell='..CELL_ID_ARRAY[1][cell_id]..' pdn='..uec_id)
