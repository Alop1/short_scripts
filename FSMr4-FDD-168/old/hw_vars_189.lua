...
-- List of links to I-PHY proxies. Format: {eNB_GE_IP_proxy1:port, ..., eNB_GE_IP_proxyProxyCount:port}
	PROXY_ADDR 	= {'10.34.166.168:2152'} --, '11.34.166.45:2152' }		
...
PGW_ADDR     = {}
SGW_ADDRS = {'10.254.220.' .. ENB_ID}
SGW_COUNT		= #SGW_ADDRS
enb_id_macro = '0x0042C'
