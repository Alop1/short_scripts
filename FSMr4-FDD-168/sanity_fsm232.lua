...
--------------------------------------------
    ...
    for uec_id = 1, #PIP_ADDR do
    	for cell_id = 1, total_cell_count do
            ...
            exec('set_ue_group simulated id='..cell_id .. uec_id ..' uec='.. uec_id.. ' release=13 category-dl=12 category-ul=13 ul_64QAM_supported=true eia=null eea=null cell='..CELL_ID_ARRAY[1][cell_id]..' pdn='..uec_id)
